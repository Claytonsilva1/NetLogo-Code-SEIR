...
168
470
prob-susceptible: defines the probability of individuals becoming susceptible after recovery from infection.
13
0.0
1
...
275
537
* If prob-susceptible = 0 , has a SIR model.\n\n* If prob-susceptible > 0, has a SIRS model.
13
123.0
1
...
@#$#@#$#@
<experiments>
  <experiment name="Experimento (10x)" repetitions="10" runMetricsEveryStep="true">
    <setup>setup
infect-one-new
infect-one-new</setup>
    <go>go</go>
    ...
    <enumeratedValueSet variable="prob-recover">
      <value value="0.015"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="prob-infect">
      <value value="0.015"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="prob-expose">
      <value value="0.0694"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="number-links-each">
      <value value="2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="population">
      <value value="100"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="prob-susceptible">
      <value value="0"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="experiment (100X)" repetitions="100" runMetricsEveryStep="true">
    <setup>setup
infect-one-new
infect-one-new</setup>
    <go>go</go>
  ...
  <experiment name="experiment (100x) prob-susceptible = 0.1" repetitions="100" runMetricsEveryStep="true">
    <setup>setup
infect-one-new
infect-one-new</setup>
    <go>go</go>
